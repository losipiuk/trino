...
public class TestQueryManagerConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(QueryManagerConfig.class)
                ...
                .setFaultTolerantExecutionHashDistributionComputeTasksToNodesMinRatio(1.0)
                .setFaultTolerantExecutionHashDistributionWriteTaskTargetSize(DataSize.of(4, GIGABYTE))
                .setFaultTolerantExecutionHashDistributionWriteTasksToNodesMinRatio(1.0)
                ...
                .setFaultTolerantExecutionSmallStageEstimationThreshold(DataSize.of(5, GIGABYTE))
                .setFaultTolerantExecutionSmallStageSourceSizeMultiplier(1.5)
