...
public class QueryManagerConfig
{
    ...
    private double faultTolerantExecutionHashDistributionComputeTasksToNodesMinRatio = 1.0;
    private DataSize faultTolerantExecutionHashDistributionWriteTaskTargetSize = DataSize.of(4, GIGABYTE);
    private double faultTolerantExecutionHashDistributionWriteTasksToNodesMinRatio = 1.0;
    ...
    private DataSize faultTolerantExecutionSmallStageEstimationThreshold = DataSize.of(5, GIGABYTE);
    private double faultTolerantExecutionSmallStageSourceSizeMultiplier = 1.5;
