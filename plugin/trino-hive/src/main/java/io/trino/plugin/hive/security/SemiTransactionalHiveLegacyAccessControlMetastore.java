...
public class SemiTransactionalHiveLegacyAccessControlMetastore
        implements LegacyAccessControlMetastore
{
    private final Function<HiveTransactionHandle, SemiTransactionalHiveMetastore> metastoreProvider;

    @Inject
    public SemiTransactionalHiveLegacyAccessControlMetastore(Function<HiveTransactionHandle, SemiTransactionalHiveMetastore> metastoreProvider)
    {
