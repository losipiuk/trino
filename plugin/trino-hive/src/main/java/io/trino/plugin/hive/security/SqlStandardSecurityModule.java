        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        newOptionalBinder(binder, SqlStandardAccessControlMetastore.class).setDefault().to(SemiTransactionalHiveSqlStandardAccessControlMetastore.class).in(Scopes.SINGLETON);
    }
