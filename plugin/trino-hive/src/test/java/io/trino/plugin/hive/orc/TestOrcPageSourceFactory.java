...
public class TestOrcPageSourceFactory
{
    ...
    public void testReadWithAcidVersionValidationHive3()
    {
        ...
        List<Nation> result = readFile(Map.of(), OptionalLong.empty(), acidInfo, tableFile.toString(), 625);
    ...
    public void testReadWithAcidVersionValidationNoVersionInMetadata()
    {
        ...
        Assertions.assertThatThrownBy(() -> readFile(Map.of(), OptionalLong.empty(), acidInfo, tableFile.toString(), 730))
